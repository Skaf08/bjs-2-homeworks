...
console.log(student.addMark(6, "geometry")); // "Ошибка, оценка должна быть числом от 1 до 5"
...
console.log(student.exclude)//"Исключен за попытку подделать оценки");


let value = 1;
function counterGenerator(value = 2) {
    let value = 3;
